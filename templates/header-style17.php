...
<header id="header" class="header header-<?php echo esc_attr( $emarket_page_header ); ?>">
	...
	<div class="header-mid">
		<div class="container">
			<div class="row">
				<!-- Logo -->
				<div class="top-header col-lg-2 col-md-3 col-sm-12 col-xs-12">
				...
				<?php if( !emarket_options()->getCpanelValue( 'disable_search' ) ) : ?>
					<div class="search-cate col-lg-7 col-md-6 col-sm-6 col-xs-6 pull-left">
	...
	<div class="header-bottom">
		<div class="container">
			...
			<div id="main-menu" class="main-menu clearfix col-lg-9 col-md-9 col-xs-12 pull-left">
