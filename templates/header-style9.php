	...
	<div class="header-mid">
		<div class="container">
			<div class="row">
				...
				<?php endif; ?>
				<!-- Sidebar Top Menu -->
				<?php if (is_active_sidebar('mid-header9')) {?>
				<div class="mid-header-right pull-right">
					<?php dynamic_sidebar('mid-header9'); ?>
				</div>
				<?php }?>
			</div>
		</div>
				...
				<div class="col-lg-2 col-md-3 col-sm-2 col-xs-2 vertical_megamenu vertical_megamenu-header pull-left">
					<div class="mega-left-title">
						<?php if ($emarket_title_text == "") { ?>
							<span><?php esc_html_e('Shop by','emarket')?></span>
							<span class="vertical-text"><?php esc_html_e('Categories','emarket')?></span>
						<?php } else { ?>
