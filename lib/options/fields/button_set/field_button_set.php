<?php
class Emarket_Options_button_set extends Emarket_Options{	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_style('emarket-opts-jquery-ui-css');

		wp_enqueue_script(
			'emarket-opts-field-button_set-js', 
			EMARKET_OPTIONS_URL.'fields/button_set/field_button_set.js', 
